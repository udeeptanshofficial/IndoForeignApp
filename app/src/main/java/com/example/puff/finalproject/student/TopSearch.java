        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        try{
                            ...
                            mLayoutManager = new LinearLayoutManager(TopSearch.this);
                            mRecyclerView.setLayoutManager(mLayoutManager);
                            mAdapter = new SuggestionAdaptor(TopSearch.this,getDataSet());
                            ...
                            ((SuggestionAdaptor) mAdapter).setOnItemClickListener(new SuggestionAdaptor
                                ...
                                public void onItemClick(int position, View v) {
                                    ...
                                    Intent intent  = new Intent(TopSearch.this,CollegeDetails.class) ;
                                    try{
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(TopSearch.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }){
